...
SOURCE_DIR="${BANGKOKAGENT_OUTPUT_DIR:-/Users/sangmin/Desktop/Claude/Projects/bangkokagent/output}"
TARGET_DIR="$PROJECT_ROOT/public"

echo "Syncing content from bangkokagent/output to public/..."

# Validate source directory
if [ ! -d "$SOURCE_DIR" ]; then
  echo "Error: Source directory not found: $SOURCE_DIR"
  echo "Please ensure bangkokagent has generated output files first."
  exit 1
fi
...
IMAGE_SOURCE="${BANGKOKAGENT_REF_DIR:-/Users/sangmin/Desktop/Claude/Projects/bangkokagent/Ref}"
